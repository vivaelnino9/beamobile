# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-27 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_act', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'acts',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[(1, 'pending'), (2, 'accepted'), (3, 'completed')], default=1, max_length=50)),
                ('date_completed', models.DateField(blank=True, null=True, verbose_name='Date Completed')),
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created On')),
                ('challenge', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bea_app.Challenge')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='location', to='bea_app.Location'),
        ),
        migrations.AddField(
            model_name='challenge_status',
            name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='organization',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bea_app.Organization'),
        ),
        migrations.AddField(
            model_name='user',
