# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-27 02:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created On')),
                ('challenge', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bea_app.Challenge', verbose_name='Challenge')),
            ],
            options={
